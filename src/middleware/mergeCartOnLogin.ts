...
export const mergeCartOnLogin = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        ...
        res.status(500).json({ success: false, message: "Error merging cart", error: error });
    }
};
